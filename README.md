...
- **Dacon, DACON-construction-accident-prevention**: 실제 데이터 기반 사고 유형 분류, 텍스트 기반 대책 생성
- **EPL 승률 예측/시뮬레이션**: 경기 데이터 기반 머신러닝, 팀 성적 시뮬레이션, 선수 기여도 분석
- **웹툰 감정/인기 분석**: 리뷰 데이터 수집, 감성 분류, 트렌드 시각화, 인기 예측
- **졸업생 검색 프로토타입**: Python 기반 검색/분석 서비스 개발
- **AI/팀 프로젝트**: 다양한 AI/ML, 데이터 분석, 서비스화 경험 (ProjectISG-AI, reeding_trip 등)
...
## 📝 최근 활동
- 2025년 5월: Presentation-Agent, Parking_Genius 등 AI/ML 포크 프로젝트 참여
- 2025년 4월: 감성 일지 자동 생성 시스템 고도화 (LangGraph 적용)
- 2025년 3월: EPL 시뮬레이션, 웹툰 감정 분석, 리뷰 시각화
...
## 🎯 나를 표현하는 한 문장
"데이터로부터 통찰을 이끌어내고, 실질적인 사회적 가치를 전달하는 데이터 사이언티스트를 지향합니다."
